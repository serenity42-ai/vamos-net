...
function ShareButton({ label, href }: { label: string; href: string }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-[#0F1F2E] transition-colors"
    >
      {label}
    </a>
  );
      ...
      <div className="lg:grid lg:grid-cols-3 lg:gap-12">
        ...
        <article className="lg:col-span-2">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span>/</span>
            <span className="text-[#4ABED9]">{article.category}</span>
          </nav>
          ...
          {/* Title */}
          <h1 className="text-3xl sm:text-4xl font-bold text-[#0F1F2E] leading-tight mb-4">
            {article.title}
          </h1>
          ...
          <div className="aspect-[16/9] bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl mb-8 flex items-center justify-center">
